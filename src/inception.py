'''
Adapted from official keras code (this is in order to use tensorflow's training on multiple replicas, which did not
play well with keras at the time of developing this project):
...
def InceptionV3(shape,
    ...
    model = tf.keras.Model(inputs, outputs=x, name='inception_v3')  # second x is just a placeholder for additional output

    return model

if __name__ == '__main__':
    InceptionV3((512,512, 3), autoencode=True)
